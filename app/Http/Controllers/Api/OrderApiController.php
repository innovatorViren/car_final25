...
class OrderApiController extends ApiController
{
    ...
    public function addOrder(Request $request)
    {
        try {
            ...
            $inputData['pay_amount'] = $request->amount ?? '';
            ...
            $inputData['merchant_order_id'] = $request->merchant_order_id ?? '';
            $inputData['order_id'] = $request->order_id ?? '';
            $inputData['payment_status'] = $request->state ?? '';
            $inputData['payable_amount'] = $request->amount ?? '';
            $inputData['currency'] = $request->currency ?? '';
            $inputData['payment_mode'] = $request->payment_mode ?? '';
